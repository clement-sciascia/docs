...
- a server or a virtual machine with a Linux distribution (a [VPS](https://www.ovh.com.au/vps/){.external}, a [Dedicated Server](https://www.ovh.com.au/dedicated-servers/all_servers.xml){.external} or [OVH Public Cloud instance](https://www.ovh.com.au/public-cloud/instances/prices/){.external})
...
Connect via SSH as a root user. If you are unsure about how to do this, please refer to our guide to [Getting started with SSH](https://docs.ovh.com/au/en/dedicated/ssh-introduction/){.external}.
