...
Connect via SSH as a root user. If you are unsure about how to do this, please refer to our guide to [Getting started with SSH](https://docs.ovh.com/ca/en/dedicated/ssh-introduction/){.external}.
