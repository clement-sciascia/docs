...
Setzen Sie hierzu einen Zeilenumbruch nach netmask **255.255.255.0** und fügen Sie Ihre Failover-IP hinzu (SERVER_IP muss durch die Haupt-IP Ihres Servers ersetzt werden).
