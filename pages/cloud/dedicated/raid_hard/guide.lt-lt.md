...
- a [dedicated server](https://www.ovh.lt/dedikuoti_serveriai/){.external} with a hardware RAID configuration
...
[Configuring software RAID](https://docs.ovh.com/lt/dedicated/raid-soft/){.external}
