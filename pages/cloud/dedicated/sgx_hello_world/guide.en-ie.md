...
- An [infrastructure dedicated server](https://www.ovh.ie/dedicated_servers/infra/){.external}, with the [SGX](https://www.ovh.ie/dedicated_servers/software-guard-extensions/){.external} option
